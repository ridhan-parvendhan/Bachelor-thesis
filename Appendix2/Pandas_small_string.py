...
concatenation_df = df['names'] + df['genre']
...
upper_case_df = df['names'].str.upper()
...
lower_case_df = df['names'].str.lower()
...
replace_df = df['genre'].str.replace('Family', 'Drama')
...
regex_match_df = df['genre'].str.contains('Drama')
...
starts_with_df = df['genre'].str.startswith('Drama')
ends_with_df = df['genre'].str.endswith('action')
...
extract_regex_df = df['genre'].str.extract(r'(,)')
...
extract_all_regex_df = df['genre'].str.findall(r'(,)')
...
match_regex_df = df['genre'].str.match(r'(Drama)')
...
strip_df = df['overview'].str.strip()
...
zfill_df = df['overview'].str.zfill(width=10)
